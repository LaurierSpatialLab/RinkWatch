...
define("modules/TOC", ['dojo/_base/declare','dojo/i18n!./nls/text','dijit/_Widget','dijit/_Templated','dojox/gfx','dojo/fx/Toggler','dijit/form/Slider'], function(declare, i18n, _Widget, _Templated, gfx, Toggler) {
...
(function() {
      ...
      if (!this.rootLayerTOC.config.noLegend) {
        if (rootLayer._tocInfos) {
          ...
          if (r.infos) {
            ...
            // !!! CHANGING FOR THIS SPECIFIC RinkWatch APPLICATION !!!
            anode.innerHTML = "<b>" + i18n.visual.clustering.legend.title + "</b><br /><br />";
 ...
 // dojo.declare("agsjs.dijit.TOC", [dijit._Widget], {
  var TOC = declare("modules/TOC", [_Widget], {
    indentSize: 18,
    swatchSize: [30, 30],
    refreshDelay: 500,
    layerInfos: null,
